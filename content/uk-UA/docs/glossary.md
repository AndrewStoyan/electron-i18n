...
Brightray [was](https://github.com/electron-archive/brightray) a static library that made [libchromiumcontent][] easier to use in applications. It is now deprecated and has been merged into Electron's codebase.
